...
if(LidarLoca_CONFIG_INCLUDED)
  return()
endif()
set(LidarLoca_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(LidarLoca_SOURCE_PREFIX /home/shw/catkin_ws_my/src/LidarLoca)
  set(LidarLoca_DEVEL_PREFIX /home/shw/catkin_ws_my/src/LidarLoca/build/devel)
  set(LidarLoca_INSTALL_PREFIX "")
  set(LidarLoca_PREFIX ${LidarLoca_DEVEL_PREFIX})
else()
  set(LidarLoca_SOURCE_PREFIX "")
  set(LidarLoca_DEVEL_PREFIX "")
  set(LidarLoca_INSTALL_PREFIX /usr/local)
  set(LidarLoca_PREFIX ${LidarLoca_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'LidarLoca' is deprecated")
...
set(LidarLoca_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/shw/catkin_ws_my/src/LidarLoca/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(LidarLoca_INCLUDE_DIRS "")
  set(_include_dirs "/home/shw/catkin_ws_my/src/LidarLoca/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'shw <shw@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${LidarLoca_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'LidarLoca' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'LidarLoca' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shw/catkin_ws_my/src/LidarLoca/${idir}'.  ${_report}")
    endif()
    _list_append_unique(LidarLoca_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND LidarLoca_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND LidarLoca_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT LidarLoca_NUM_DUMMY_TARGETS)
      set(LidarLoca_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::LidarLoca::wrapped-linker-option${LidarLoca_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR LidarLoca_NUM_DUMMY_TARGETS "${LidarLoca_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::LidarLoca::wrapped-linker-option${LidarLoca_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND LidarLoca_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shw/catkin_ws_my/src/LidarLoca/build/devel/lib;/home/shw/ROScode/autoware_Sun/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(LidarLoca_LIBRARY_DIRS ${lib_path})
      list(APPEND LidarLoca_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'LidarLoca'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND LidarLoca_LIBRARIES ${lib})
    endif()
  endif()
...
set(LidarLoca_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${LidarLoca_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 LidarLoca_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${LidarLoca_dep}_FOUND)
      find_package(${LidarLoca_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${LidarLoca_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(LidarLoca_INCLUDE_DIRS ${${LidarLoca_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(LidarLoca_LIBRARIES ${LidarLoca_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${LidarLoca_dep}_LIBRARIES})
  _list_append_deduplicate(LidarLoca_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(LidarLoca_LIBRARIES ${LidarLoca_LIBRARIES})

  _list_append_unique(LidarLoca_LIBRARY_DIRS ${${LidarLoca_dep}_LIBRARY_DIRS})
  list(APPEND LidarLoca_EXPORTED_TARGETS ${${LidarLoca_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${LidarLoca_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
